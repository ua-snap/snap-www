...
<thead>
<tr>
<th scope="col"><a href="<?php echo Config::$geonetworkMetadataUrlBase; ?>34">Projected Monthly Average Temperature 771 m metadata</a></th>
<th scope="col"><a href="<?php echo Config::$geonetworkMetadataUrlBase; ?>35">Projected Monthly Total Precipitation 771 m metadata</a></th>
</tr>
</thead>
<tbody>
<tr>
...
$(function() {
    ...
    $('.downloadsTable a')
    .each(function(index) {
       $(this).attr('href', window.snapConfig.dataPath + $(this).text() ); 
    });
...
+ Historical Monthly Temperature and Precipitation - 771 m
+ Historical Derived Temperature Products - 771 m
+ Historical Derived Precipitation Products - 771 m

+ Historical Monthly Temperature and Precipitation - 2 km
+ Historical Derived Temperature Products - 2 km
+ Historical Derived Precipitation Products - 2 km

