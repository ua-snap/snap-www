...
<p>SNAP obtains GCM outputs from the Lawrence Livermore National Laboratory Program for <a href="http://www-pcmdi.llnl.gov/" target="_blank">Climate Model Diagnosis and Intercomparison</a> (PCMDI) data portal.  PCMDI supports CMIP and is dedicated to improving methods and tools for the diagnosis and intercomparison of General Circulation Models that simulate global climate.  There are multiple ensemble runs and scenarios available for download from the CMIP3 portal.  SNAP utilizes the first ensemble model run and the <a target="_blank" href="http://www.grida.no/publications/other/ipcc_sr/?src=/climate/ipcc/emission/index.htm">20c3m, B1, A1B, and A2 scenario</a> datasets for downscaling.  GCM data are downloaded in netCDF format.</p>
