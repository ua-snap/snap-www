...
<p>
SNAP obtains GCM outputs from the Lawrence Livermore National Laboratory Program for <a href="http://www-pcmdi.llnl.gov/" >Climate Model Diagnosis and Intercomparison</a> (PCMDI) data portal.  PCMDI supports CMIP and is dedicated to improving methods and tools for the diagnosis and intercomparison of Global Climate Models that simulate global climate.  There are multiple ensemble runs and scenarios available for download from the CMIP3 portal.  SNAP utilizes the first ensemble model run and the 20c3m, B1, A1B, and A2 <scenario> datasets for downscaling.  GCM data are downloaded in netCDF format.
</p>
