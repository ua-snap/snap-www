...
class VideoAttachmentTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testRenderLinkedVideo() {
        $this->assertEquals('<p><a target="_blank" href="http://www.youtube.com/watch?v=u5DiHp76gjs&feature=results_main&playnext=1&list=PLBBDD34F33BAF19CD
">Alaskan Native thoughts on climate change</a></p>', $this->video->getLinkedVideo(), "Video resource should produce a string of HTML to render a link to a video on another site");
    ...
    public function testRenderFileLink() {
        $this->assertEquals('<p class="attachment"><a href="attachments/path_to_nowhere.mp4 />Direct Download (<span>.mp4</span>, <span>20 MB</span> <img src="images/filetypes/video.png" alt=""/></p>', $this->video->getFileVideo(), "Video should provide a link to a downloadable version of a video");
    }
}
