...
?>
        <div id="main_body">
            ...
            <div id="main_content" style="font-size: 15px;" >
                ...
                <div>
                    <img alt="Denali Building" src="images/building.jpg" style="margin-right: 15px; border: 1px solid #999999; padding: 3px; width: 400px; float: left;" />
                    ...
                    <img alt="Front Desk" src="images/frontdesk.jpg" style="margin-left: 15px; border: 1px solid #999999; padding: 3px; width: 300px; float: right;" />
