...
?>
		<div id="main_body">
			...
			<div id="main_content" style="font-size: 15px;" >
				<!--<div class="subHeader" style="text-align: left;">all <img style="vertical-align: middle" height="55" src="images/about.png" alt="About" /> the Scenarios Network for Alaska &amp; Arctic Planning</div>-->
				...
				<div style="style=float: left;">
					<div class="heading" id="need">History of SNAP</div>
					<div style="display: none;" class="sec_body">
					...
					<div id="devel" class="heading">People and Work Philosophy</div>
					<div style="display: none;" class="sec_body">
					...
					<div id="devel" class="heading">Data &amp; Research</div>
					<div style="display: none;" class="sec_body">
					...
					<div id="devel" class="heading">Outreach</div>
					<div style="display: none;" class="sec_body">
