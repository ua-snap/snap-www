...
<p>Our principal products are downscaled historical and projected monthly climate data, primarily temperature and precipitation.  Projected data are produced for three <a href="/faq.php#faq_4">emission scenarios</a> (B1, A1B, A2).  Additionally, SNAP produces derived data from the above base datasets through various <a href="modeling.php">modeling</a> efforts.  Derived data products include potential evapotranspiration, vegetation, fire, permafrost, day of freeze, day of thaw, the subsequent length of growing season, as well as decadal, seasonal and annual averages.  For a full list of our available data, please visit the SNAP <a href="gisdata.php">Data</a> page.  To explore the data with an interactive map, please visit the <a  href="maps.php">map tool</a>.</p>
