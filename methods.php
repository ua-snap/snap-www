...
<p>SNAP selects the 5 <a href="http://en.wikipedia.org/wiki/Global_climate_model" target="_blank">General Circulation Models</a> (GCM) that <a href="TBD">perform best</a> in Alaska and the Arctic. Outputs from these models are then <a href="/downscaling.php">downscaled</a> using <a href="http://prism.oregonstate.edu/" target="_blank">PRISM</a> data&mdash;which accounts for land features such as slope, elevation, and proximity to coastlines&mdash;as baseline climate data.  This same downscaling procedure is applied to historical <a href="http://www.cru.uea.ac.uk/" target="_blank">Climate Research Unit</a> (CRU) data.  The final products are high resolution monthly climate data for ~1901-2100 for Alaska and large regions of Canada.  Where PRISM data are not available, GCM and historical data are downscaled to other baseline climate datasets such as <a href="http://www.cru.uea.ac.uk/" target="_blank">CRU</a> data products.  Outputs from the 5 models are averaged in order to reduce the error associated with dependence on a single model.  As new data become available, we continually update the SNAP climate datasets, applying these same methods to other areas of the Arctic and the world.</p>

<p>Our principal products are downscaled historical and projected monthly climate data, primarily temperature and precipitation.  Projected data are produced for three <a href="http://en.wikipedia.org/wiki/Special_Report_on_Emissions_Scenarios" target="_blank">emission scenarios</a> (B1, A1B, A2).  Additionally, SNAP produces derived data from the above base datasets through various <a href="modeling.php">modeling</a> efforts.  Derived data products include potential <a href="http://en.wikipedia.org/wiki/Evapotranspiration" target="_blank">evapotranspiration</a>, vegetation, fire, permafrost, day of freeze, day of thaw, the subsequent <a href="http://en.wikipedia.org/wiki/Growing_season" target="_blank">length of growing season</a>, as well as decadal, seasonal and annual averages.  For a full list of our available data, please visit the SNAP <a href="gisdata.php">Data</a> page.  To explore the data with an interactive map, please visit the <a target="_blank" href="maps.php">map tool</a>.</p>
